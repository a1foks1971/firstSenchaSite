...
Ext.define('Ext.calendar.form.CalendarPicker', {
    ...
    /* eslint-disable max-len */
    itemTpl: '<div><div class="' + Ext.baseCSSPrefix + 'calendar-picker-list-icon" style="background-color: {color};"></div>' + '<div class="' + Ext.baseCSSPrefix + 'calendar-picker-list-text ' + Ext.baseCSSPrefix + 'list-label">{title:htmlEncode}</div></div>',
    /* eslint-enable max-len */
    edgePicker: {
        userCls: Ext.baseCSSPrefix + 'calendar-picker-list'
    },
